...
const sessionOption = session({
    ...
    cookie: {
        maxAge: 1000 * 60 * 60 * 24 * 7, // isso é quanto tempo o cookie vai durar 
        //      milisegundos|segundos|minuto|horas|dias
        httpOnly: true
    }
})
...
app.set('views', path.resolve(__dirname, 'aula13', 'src', 'views'));
